...
var file_api_proto_user_proto_rawDesc = []byte{
	...
	0x52, 0x02, 0x69, 0x64, 0x32, 0x3b, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x33, 0x0a, 0x06,
...
var file_api_proto_user_proto_depIdxs = []int32{
	0, // 0: api.User.Create:input_type -> api.CreateRequest
	1, // 1: api.User.Create:output_type -> api.CreateResponse
